...
local RedrawColors = function(mode)
  if mode == 'n' then
    ...
    api.nvim_command('hi NeoLineActiveInverseBegin guibg='..normal_bg..' guifg='..blue)
    api.nvim_command('hi NeoLineActiveInverseEnd guibg='..normal_bg..' guifg='..blue)
    api.nvim_command('hi NeoLineTabLineSel gui=Bold guibg='..blue..' guifg='..white)
    api.nvim_command('hi NeoLineTabLineSelSeparator gui=bold guifg='..blue)
  end
  if mode == 'i' then
    ...
    api.nvim_command('hi NeoLineActiveInverseBegin guibg='..normal_bg..' guifg='..green)
    api.nvim_command('hi NeoLineActiveInverseEnd guibg='..normal_bg..' guifg='..green)
  ...
  if mode == 'v' or mode == 'V' or mode == '' then
    ...
    api.nvim_command('hi NeoLineActiveInverseBegin guibg='..normal_bg..' guifg='..purple)
    api.nvim_command('hi NeoLineActiveInverseEnd guibg='..normal_bg..' guifg='..purple)
  ...
  if mode == 'c' then
    ...
    api.nvim_command('hi NeoLineActiveInverseBegin guibg='..normal_bg..' guifg='..yellow)
    api.nvim_command('hi NeoLineActiveInverseEnd guibg='..normal_bg..' guifg='..yellow)
  ...
  if mode == 'Rv' then
    ...
    api.nvim_command('hi NeoLineActiveInverseBegin guibg='..normal_bg..' guifg='..red)
    api.nvim_command('hi NeoLineActiveInverseEnd guibg='..normal_bg..' guifg='..red)
  ...
  if mode == 't' then
    ...
    api.nvim_command('hi NeoLineActiveInverseBegin guibg='..normal_bg..' guifg='..turquoise)
    api.nvim_command('hi NeoLineActiveInverseEnd guibg='..normal_bg..' guifg='..turquoise)
